...
def optimize_route_tsp(drivers):
    ...
    while remaining:
        last_coord = route[-1]['coordinates']
        nearest = min(remaining, key=lambda d: calculate_distance(last_coord, d['coordinates']))
...
def optimize_routes():
    ...
    try:
        ...
        # Determine optimal number of vans
...
if __name__ == '__main__':
    ...
    app.run(host='127.0.0.1', debug=False, port=5555, use_reloader=False)
